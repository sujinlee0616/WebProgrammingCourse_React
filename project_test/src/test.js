...
class Modal extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="modal fade" id="moreBtn" tabIndex="-1" role="dialog" ariaLabelledby="exampleModalLabel"
                 ariaHidden="false">
...
class ItemList extends React.Component {
    ...
    render() {
        const html = this.props.martitems.slice(0, 3).map((m) => <Item item={m}
                                                                       setCheckItems={this.props.setCheckItems}/>)
    ...
    render() {
        return (
            <tr className="mall_result" id="product1">
                ...
                <ItemList key1="lm" martitems={this.props.kw_data.data['lm']} keyword={this.props.kw_data.keyword}
                          showModalBtn={this.props.showModalBtn} setCheckItems={this.props.setCheckItems}/>
                <ItemList key1="hp" martitems={this.props.kw_data.data['hp']} keyword={this.props.kw_data.keyword}
                          showModalBtn={this.props.showModalBtn} setCheckItems={this.props.setCheckItems}/>
                <ItemList key1="em" martitems={this.props.kw_data.data['em']} keyword={this.props.kw_data.keyword}
                          showModalBtn={this.props.showModalBtn} setCheckItems={this.props.setCheckItems}/>
                <ItemList key1="cp" martitems={this.props.kw_data.data['cp']} keyword={this.props.kw_data.keyword}
                          showModalBtn={this.props.showModalBtn} setCheckItems={this.props.setCheckItems}/>
            </tr>
        );
    }
    ...
    render() {
        let keywordListHtml = this.props.searchKeywordList.map(m =>
            <li className="selected">
                {m}
                <span className="xBtn" data-keyword={m} onClick={(e) => {
                    this.props.removeFromSearchKeywordList(e)
                }}>X</span>
            </li>
        )
                                        ...
                                        <li className="current">
                                            <input
                                                onKeyDown={(e) => {
                                                    e.stopPropagation();
                                                    if (e.keyCode == 13) {
                                                        this.props.addToSearchKeywordList(this.state.keyword);
                                                ...
                                                className="hidden_input" tabIndex="1" autoComplete="off"
                                                autoCorrect="off" autoCapitalize="off" spellCheck="false" role="textbox"
                                                ariaAutocomplete="list" placeholder=""
                                                style={{"width": {size}}}
                                            />
                                        </li>
                                    </ul>
                                    <button onClick={() => {
                                        this.props.setMartData()
                                    }} className="sliderBtn pl-0">검색
                                    </button>
                                </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <MartTable martdata={this.state.martdata} showModalBtn={this.showModalBtn}
                                   setCheckItems={this.setCheckItems}/>
                        {this.state.saveItems.length != 0 ?
                            <SaveItems saveItems={this.state.saveItems} setSaveItems={this.setSaveItems}/> : null}
