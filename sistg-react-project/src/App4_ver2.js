...
/* [방법2] class 사용 - React lifecycle에 따른 함수(componentDidMount, ...) 알아야함 */
/* JSON 파일을 axios로 get해서 읽어준 후, state에다가 그 데이터를 넣어줬음 */
class App4 extends Component{
    ...
    render() {
        ...
        const list_html=this.state.movie.map((m,key)=> // map: 마치.. for each문처럼... ★★★ - 아래의 <forEach,map> 주석 참고
